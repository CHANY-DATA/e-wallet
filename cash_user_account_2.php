               ...
               <?php
					...
					if(isset($_POST['cash']))
					{
						...
						if (empty($acc_balance))
						{
							...
							echo "<a href='user_pan.php'><br><font size='4px' face='Batang' color='#66cc66'><strong><center>Back to the Admin Panel!</center></strong></font></a>";
						}
							else
						{
						$x=$acc_balance1 + $acc_balance2;
						...
						mysqli_query($con,$query) or die(mysqli_error($con));
							...
							$query="UPDATE account SET  acc_balance=$x WHERE nid='$nid' AND acc_number='$acc_number'";
						mysqli_query($con,$query) or die(mysqli_error($con));
